// @routes-hash 07e7d104d8bf711890c6ebdde9511241
...
import route51 from "./routes/setting/getOpenRouterImageModels";
import route52 from "./routes/setting/getOpenRouterModels";
import route53 from "./routes/setting/getSetting";
import route54 from "./routes/setting/getVideoModelDetail";
import route55 from "./routes/setting/getVideoModelList";
import route56 from "./routes/setting/updateModel";
...
import route65 from "./routes/storyboard/storyboardImageEdit";
...
export default async (app: Express) => {
  ...
  app.use("/setting/getOpenRouterImageModels", route51);
  app.use("/setting/getOpenRouterModels", route52);
  app.use("/setting/getSetting", route53);
  app.use("/setting/getVideoModelDetail", route54);
  app.use("/setting/getVideoModelList", route55);
  app.use("/setting/updateModel", route56);
  ...
  app.use("/storyboard/storyboardImageEdit", route65);
