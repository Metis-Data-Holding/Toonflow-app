// @routes-hash 35dbbed47ad59fa1d0b5dbce15081a84
...
import route51 from "./routes/setting/getOpenRouterModels";
...
import route64 from "./routes/storyboard/storyboardImageEdit";
import route65 from "./routes/storyboard/uploadImage";
import route66 from "./routes/task/getMyTaskApi";
...
export default async (app: Express) => {
  ...
  app.use("/setting/getOpenRouterModels", route51);
  ...
  app.use("/storyboard/storyboardImageEdit", route64);
  app.use("/storyboard/uploadImage", route65);
  app.use("/task/getMyTaskApi", route66);
  app.use("/task/getTaskCategories", route67);
